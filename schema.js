...
client.query(
    ...
    'CREATE TABLE users ( user_id NUMERIC PRIMARY KEY, display_name varchar(30), difficulty smallint NOT NULL, token varchar(100));' +
...
//    'CREATE TYPE part AS ENUM(\'n\',\'v\',\'pn\',\'adj\',\'adv\',\'c\',\'pr\',\'i\');' +
    ...
    'CREATE TABLE words (word_id serial PRIMARY KEY, word varchar(40) NOT NULL, frequency integer, nounorverb char(1), difficulty smallint DEFAULT 0);'  +
